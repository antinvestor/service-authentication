...
func NewPartitionSvc(containerOpts ...definition.ContainerOption) definition.TestResource {
	opts := definition.ContainerOpts{
		...
		Ports:          []string{"8083/tcp", "50051/tcp"},
		UseHostMode:    false,
...
func (d *partitionDependancy) Name() string {
	return d.opts.ImageName
}

func (d *partitionDependancy) Container() testcontainers.Container {
	return d.container
}
...
func (d *partitionDependancy) GetDS(ctx context.Context) frame.DataSource {
...
func (d *partitionDependancy) GetInternalDS(ctx context.Context) frame.DataSource {
...
func (d *partitionDependancy) GetRandomisedDS(ctx context.Context, prefix string) (frame.DataSource, func(context.Context), error) {
	return d.GetDS(ctx), func(context.Context) {}, nil
}

func (d *partitionDependancy) Cleanup(ctx context.Context) {
	if d.container != nil {
