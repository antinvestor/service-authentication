...
const (
	DefaultSecureCookieHashKey  = "d1f4f1a3b8d84f79e6d4b8b5c3f04725a8a7d6b4c2f9a987d5e4f3a2b1c086d1"
	DefaultSecureCookieBlockKey = "a7e7b4f8d2e5a3c1f0b6d9d4f3a5c20798d1c1e7c4f6a3e4b0e5c2f4a7d6b301"
)
...
type AuthenticationConfig struct {
	...
	// DefaultTenantID and DefaultPartitionID are used as fallback claims for
	// service account tokens when the SA cannot be found in the tenancy DB.
	// These correspond to the System Manager partition hierarchy.
	DefaultTenantID    string `envDefault:"c2f4j7au6s7f91uqnojg" env:"DEFAULT_TENANT_ID"`
	DefaultPartitionID string `envDefault:"c2f4j7au6s7f91uqnokg" env:"DEFAULT_PARTITION_ID"`
