...
-- for participant identity, and opportunities services for trust-
-- linked opportunity data and API access.
...
INSERT INTO clients (
    ...
    'system_int openid',
    '{"opportunities_api":["*"],"opportunities_crawler":["*"],"service_notification":["*"],"service_profile":["*"],"service_tenancy":["*"]}',
    'private_key_jwt',
