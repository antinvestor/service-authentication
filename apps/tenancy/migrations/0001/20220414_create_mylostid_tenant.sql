...
INSERT INTO partitions (id, tenant_id, partition_id, name, description, properties)
    VALUES('9bsv0s4qlfug02s9at9g', '9bsv0s4qlfug02s9at8g', '9bsv0s4qlfug02s9at9g', 'My Lost Id', 'Default partition to manage access to my lost id', '{"scope": "openid offline offline_access profile contact", "audience": ["service_tenancy", "service_devices", "service_profile", "service_notification", "service_files", "service_ledger", "service_mylostid", "service_ocr"], "logo_uri": "https://static.mylostid.com/logo.png", "redirect_uris": ["https://mylostid.com/callback.html"]}');
