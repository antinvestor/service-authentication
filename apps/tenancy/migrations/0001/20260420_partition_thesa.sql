...
INSERT INTO clients (
    ...
    '{"service_tenancy":["*"],"service_device":["*"],"service_profile":["*"],"service_notification":["*"],"service_payment":["*"],"service_ledger":["*"],"service_setting":["*"],"service_file":["*"],"service_trustage":["*"],"service_thesa":["*"],"service_audit":["*"],"service_geolocation":["*"]}',
