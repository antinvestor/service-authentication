...
INSERT INTO clients (
    ...
    '{"service_chat": ["*"],"service_device": ["*"],"service_file": ["*"],"service_geolocation": ["location_ingest","area_view"],"service_profile": ["*"]}',
