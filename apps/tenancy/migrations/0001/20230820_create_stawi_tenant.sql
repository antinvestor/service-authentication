...
INSERT INTO partitions (id, tenant_id, partition_id, name, description, properties)
    VALUES('9bsv0s0hijjg02qk7l1g', 'c2f4j7au6s7f91uqnojg', 'c2f4j7au6s7f91uqnokg',
           ...
           '{"scope": "openid offline offline_access profile contact", "audience": ["service_chat_drone","service_chat_gateway", "service_devices", "service_profile", "service_files"], "logo_uri": "https://static.stawi.im/logo.png", "redirect_uris": ["https://app.stawi.im/sso/redirect", "com.antinvestor.chat://sso/redirect", "http://localhost:5170/sso/redirect"], "post_logout_redirect_uris": ["https://app.stawi.im/sso/logout"]}');
