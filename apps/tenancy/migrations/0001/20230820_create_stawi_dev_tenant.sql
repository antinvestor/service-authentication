...
INSERT INTO partitions (id, tenant_id, partition_id, name, description, properties)
    VALUES('9bsv0s0hijjg02qks6i0', '9bsv0s0hijjg09bzz6dg', '9bsv0s0hijjg02qks6i0',
           ...
           '{"scope": "openid offline offline_access profile contact", "audience": ["service_chat_drone","service_chat_gateway", "service_devices", "service_profile", "service_files"], "logo_uri": "https://static.stawi.im/logo.png", "redirect_uris": ["https://app-dev.stawi.im/sso/redirect", "com.antinvestor.chat://sso/redirect", "https://localhost:5170/sso/redirect"], "post_logout_redirect_uris": ["https://app-dev.stawi.im/sso/logout", "http://localhost:8008/sso/logout", "https://localhost:5170/sso/logout"]}');
