...
INSERT INTO partitions (id, tenant_id, partition_id, name, description, properties)
    VALUES('9bsv0s0hijjg02qks6i0', '9bsv0s3pbdv002o80qfg', '9bsv0s3pbdv002o80qhg',
           ...
           '{"scope": "openid offline_access profile contact", "audience": ["service_chat_drone","service_chat_gateway", "service_devices", "service_profile", "service_files"], "logo_uri": "https://static.stawi.im/logo.png", "redirect_uris": ["https://app-dev.stawi.im/sso/callback", "http://localhost:8008/sso/callback", "https://localhost:5170"], "post_logout_redirect_uris": ["https://app-dev.stawi.im/sso/logout", "http://localhost:8008/sso/logout", "https://localhost:5170/sso/logout"]}');
