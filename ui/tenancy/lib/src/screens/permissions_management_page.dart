...
class _PermissionManagerPageState extends State<_PermissionManagerPage> {
  ...
  Future<void> _searchProfile() async {
    ...
    try {
      final profileClient =
          widget.ref.read(profileServiceClientProvider);
  ...
  Future<void> _applyChanges() async {
    ...
    try {
      final repo = widget.ref.read(partitionRepositoryProvider);
      ...
      child: Row(
        children: [
          Icon(
            ...
            size: 16,
            color: widget.isSuperUser ? Colors.green : theme.colorScheme.tertiary,
          ),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
