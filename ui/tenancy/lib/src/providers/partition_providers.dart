...
final tenantsProvider = FutureProvider<List<TenantObject>>((ref) async {
  final repo = ref.watch(partitionRepositoryProvider);
...
final serviceAccountsForPartitionProvider =
    FutureProvider.family<List<ServiceAccount>, String>((
      ref,
      partitionId,
    ) async {
      final repo = ref.watch(partitionRepositoryProvider);
...
final clientsForPartitionProvider =
    FutureProvider.family<List<OAuthClient>, String>((ref, partitionId) async {
      final repo = ref.watch(partitionRepositoryProvider);
